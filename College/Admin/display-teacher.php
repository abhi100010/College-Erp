	...
	?>
		<div class="container  mt-1 border border-secondary mb-1">
			<div class="row text-white bg-primary pt-5">
				...
				<div class="col-md-8">
					<h3 class="ml-5"><?php echo $row['employee_name'] ?></h3><br>
					<div class="row">
						<div class="col-md-6">
			...
			<div class="row pt-3">
				...
				<div class="col-md-4"><h5>Highest_Qualification:</h5> <?php echo $row['hq']  ?></div>
			</div>
			<div class="row pt-3">
				<div class="col-md-4"><h5>Adress:</h5> <?php echo $row['address']  ?></div>
